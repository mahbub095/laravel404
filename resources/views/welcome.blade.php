...
{{--
                            ...
                            <?php	echo  count(Session::get('cart'));
...
<main>
    ...
    <div class="just-product">
        ...
        @foreach($products as $product)
            ...
            <div class="product-item item-shadow">
                ...
                <h3 class="price">৳{{$product->flate_price}}</h3>
                <small class="price-del"><del>৳{{$product->regular_price}}</del></small>
                <h3 class="price"> <a class="btn btn-success" href="{{ url('single-product/'.$product->id) }}">   Detail </a>  <a class="btn btn-success" href="{{ url('add-to-cart/'.$product->id) }}">  Add  Cart </a>  </h3>
