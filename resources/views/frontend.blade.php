...
<head>
    ...
    <!-- Custom stlylesheet -->
    <link type="text/css" rel="stylesheet" href="{{asset('front/css/styleshom.css')}}" />
                        ...
                        <div class="custom-menu">
                            <div id="shopping-cart">
                                    ...
                                    <div class="product product-widget">
                                        ...
                                        <div class="product-body">
                                            <h3 class="product-price">
                                                ${{$details['regular_price']}} <span class="qty">x{{$details['quantity']}}</span>
                                            </h3>
                                ...
                                <div class="shopping-cart-btns">
                                    <button class="main-btn"><a href="{{route('cart')}}"> View Cart</a></button>
            ...
            <div class="menu-nav">
                ...
                <ul class="menu-list">
                    ...
                    <li class="dropdown mega-dropdown"><a class="dropdown-toggle" data-toggle="dropdown" aria-expanded="true">Women <i class="fa fa-caret-down"></i></a>
                        <div class="custom-menu">
                            <div class="row">
                                PICKED FOR YOU                  <div class="col-md-4">
                                    <ul class="list-links">
                                        <li>
                            ...
                            <div class="row">
                                <div class="col-md-3">
                                    <div class="hidden-sm hidden-xs">
                                        <a class="banner banner-1" href="#">
                                            <img src="{{asset('front/img/banner06.jpg')}}" alt="">
                                            <div class="banner-caption text-center">
                                ...
                                <div class="col-md-3">
                                    <div class="hidden-sm hidden-xs">
                                        <a class="banner banner-1" href="#">
                                            <img src="{{asset('front/img/banner07.jpg')}}" alt="">
                                            <div class="banner-caption text-center">
                                ...
                                <div class="col-md-3">
                                    <div class="hidden-sm hidden-xs">
                                        <a class="banner banner-1" href="#">
                                            <img src="{{asset('front/img/banner08.jpg')}}" alt="">
                                            <div class="banner-caption text-center">
                                ...
                                <div class="col-md-3">
                                    <div class="hidden-sm hidden-xs">
                                        <a class="banner banner-1" href="#">
                                            <img src="{{asset('front/img/banner09.jpg')}}" alt="">
                                            <div class="banner-caption text-center">
            ...
            <div class="col-md-9 col-sm-6 col-xs-6">
                <div class="row">
                    <div id="product-slick-1" class="product-slick">
                              ...
                              <?php
                              $products = DB::select('SELECT * FROM product WHERE product_position = "deal" ');
            ...
            <div class="col-md-3 col-sm-6 col-xs-6">
                <div class="product product-single product-hot">
                    <div class="product-thumb">
                        ...
                        <button class="main-btn quick-view"><i class="fa fa-search-plus"></i> Quick view</button>
                        <img src="{{asset('front/img/product01.jpg')}}" alt="">
                    </div>
                    <div class="product-body">
                        <h3 class="product-price">$32.50 <del class="product-old-price">$45.00</del></h3>
                        <div class="product-rating">
...
<div class="section section-grey">
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-8">
                <div class="banner banner-1">
                    <img src="{{asset('front/img/banner13.jpg')}}" alt="">
                    <div class="banner-caption text-center">
                        <h1 class="primary-color">HOT DEAL<br><span class="white-color font-weak">Up to 50% OFF</span></h1>
                        <button class="primary-btn">Shop Now</button>
                    </div>
...
<div class="section">
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-3 col-sm-6 col-xs-6">
                <div class="banner banner-2">
                    <img src="{{asset('front/img/banner15.jpg')}}" alt="">
                    <div class="banner-caption">
                        <h2 class="white-color">NEW<br>COLLECTION</h2>
                        <button class="primary-btn">Shop Now</button>
                    </div>
