    ...
    <main>
        ...
        <div class="slider-area ">
            <div class="slider-active">
                <!-- Single Slider -->
                <div class="single-slider slider-height d-flex align-items-center" data-background="{{asset('frontend/img/hero/h1_hero.jpg')}}">
                    <div class="container">
                        <div class="row">
                    ...
                    <div class="slider-bottom"  >
                        ...
                        <div class="slider-video d-flex align-items-center" data-animation="fadeInRight" data-delay=".8s">
                            ...
                            <img src="{{asset('frontend/img/icon/video_btn.png')}}" alt="">
                            </a>
                        </div>
                    </div>
                </div>
