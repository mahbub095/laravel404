                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4 hidden-sm hidden-xs">
                                        <a class="banner banner-2" href="#">
                                            <img src="{{asset('front/img/banner04.jpg')}}" alt="">
                ...
                <div class="product product-details clearfix">
                    <div class="col-md-6">
                        <div id="product-main-view">
                            ...
                            <div class="product-view">
                                <img src="{{asset('front/img/main-product03.jpg')}}" alt="">
                            </div>
                            <div class="product-view">
                        ...
                        <div id="product-view">
                            ...
                            <div class="product-view">
                                <img src="{{asset('front/img/thumb-product02.jpg')}}" alt="">
                            </div>
                            <div class="product-view">
                                <img src="{{asset('front/img/thumb-product03.jpg')}}" alt="">
                            </div>
                            <div class="product-view">
                                <img src="{{asset('front/img/thumb-product04.jpg')}}" alt="">
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6">
